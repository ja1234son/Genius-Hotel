    ...
    */
    ...
    public function store(Request $request){
        ...
        if (Auth::attempt($credentials, $remember)) {
            ...
            // Check user_type
            if ($user->user_type === 'employee' || strpos($user->email, 'admin.com') !== false) {
                return redirect('admin-dashboard');
            } 
            
            return redirect(RouteServiceProvider::HOME)->with('success', 'You are now successfully logged in. Feel free to book any room.');
        } else {
