            ...
            <div class="col-xl-3 col-xxl-6 col-sm-6">
                <div class="card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="invoice-num">{{$roomtype}}</h2>
                            <p class="mb-0 invoice-num1">
                                
                                <h4 class="text-success me-6">Room Types</h4>
                            </p>
            ...
            <div class="col-xl-3 col-xxl-6 col-sm-6">
                <div class="card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="invoice-num">{{$room}}</h2>
                            <p class="mb-0">
                                
                                <h4 class="text-success me-1">Rooms</h4> 
                            </p>
            ...
            <div class="col-xl-3 col-xxl-6 col-sm-6">
                <div class="card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="invoice-num">{{$department}}</h2>
                            <p class="mb-0">
                              

                                <h4 class="text-danger me-1">Departments</h4> 
                            </p>
            ...
            <div class="col-xl-3 col-xxl-6 col-sm-6">
                <div class="card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="invoice-num">{{$staffs}}</h2>
                            <p class="mb-0">
                               
                                <h4 class="text-danger me-1">Staffs</h4>
                            </p>
