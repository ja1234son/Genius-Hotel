...
<head>
    ...
    <title>{{ config('app.name', 'Hotelier') }} | REGISTER</title>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            ...
                                            <p class="text-muted">Register Here to continue Booking Your Favorite Rooms.</p>
                                        </div>
                                        ...
                                        @if (session('success'))
                                            ...
                                            <div class="alert alert-success alert-dismissible alert-label-icon rounded-label fade show"
                                                role="alert">
                                                <i class="ri-error-warning-line label-icon"></i><strong>Success</strong>
                                                -
                                                {{ session('success') ?? '' }}
                                                <button type="button" class="btn-close" data-bs-dismiss="alert"
                                                    aria-label="Close"></button>
                                        ...
                                        <div class="mt-4">
                                            <form method="POST" action="{{ route('register.post') }}">
                                                @csrf
                                                <div class="mb-3">
                                                    <label for="login" class="form-label">First Name<span
                                                ...
                                                <div class="mb-3">
                                                    <label for="login" class="form-label">Middle Name<span
                                                            class="required">*</span></label>
                                                    <input type="text" class="form-control" id="login"
                                                ...
                                                <div class="mb-3">
                                                    <label for="login" class="form-label">Last Name<span
                                                            class="required">*</span></label>
                                                    <input type="text" class="form-control" id="login"
                                                ...
                                                <div class="mb-3">
                                                    <label for="login" class="form-label">Phone Number<span
                                                            class="required">*</span></label>
                                                    <input type="number" class="form-control" id="login"
                                                        name="phone_no" value="{{ old('phone_no') }}"
                                                        placeholder="Enter your phone number">
                                                </div>

                                                <div class="mb-3">
                                                    <label for="login" class="form-label">Gender<span
                                                            class="required">*</span></label>
                                                    <select class="form-control" id="login"
                                                        name="gender" value="{{ old('gender') }}">
                                                    <option value="0">--Select your gender please--</option>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="position-relative auth-pass-inputgroup mb-3">
                                                        <input type="password"
                                                            ...
                                                            placeholder="Enter your password"  value="{{ old('password') }}" id="password">
                                                        <button
                                                            class="btn btn-link position-absolute end-0 text-decoration-none text-muted password-addon top-0 shadow-none"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="position-relative auth-pass-inputgroup mb-3">
                                                        <input type="password"
                                                            ...
                                                            placeholder="Enter your password"  value="{{ old('password_confirmation') }}" id="password">
                                                        <button
                                                            class="btn btn-link position-absolute end-0 text-decoration-none text-muted password-addon top-0 shadow-none"
                                                            type="button" id="password-addon"><i
                                                                class="ri-eye-fill align-middle"></i></button>
                                                ...
                                                <p style="float: right; margin-top:-19.9px;" class="text-muted">Already have an account? <a href="{{ route('login') }}">Login</a></p>
