...
<head>
    ...
    <title>{{ config('app.name', 'Hotelier') }} | LOGIN</title>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            ...
                                            <p class="text-muted">Sign in to continue Booking Your Favorite Rooms.</p>
                                        </div>
                                            ...
                                            <form method="POST" action="{{ route('login.post') }}">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="position-relative auth-pass-inputgroup mb-3">
                                                        <input type="password"
                                                            class="form-control pe-5 password-input" value="{{ old('password') }}" name="password"
                                                ...
                                                <p style="float: right; margin-top:-19.9px;" class="text-muted">Do not have an account? <a href="{{ route('register') }}">Register</a></p>
