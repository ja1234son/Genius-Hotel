                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-validation">
                                <form class="needs-validation" action="{{url('departments')}}"  method="post"  novalidate >
                                    @csrf
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control" id="validationCustom01"   name="title" placeholder="Enter department name"
                                                     required>
                                                </div>
                                            </div>
