                                    ...
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="text" value="{{old('first_name')}}" class="form-control" id="validationCustom01" name="first_name"
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="email" class="form-control"  value="{{old('last_name')}}" name="last_name" id="validationCustom02"
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="email" class="form-control"  value="{{old('email')}}" placeholder="Enter Valid Email"  name="email"  id="validationCustom03"required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="number"  value="{{old('phone')}}" class="form-control"  name="phone" id="validationCustom06" 
