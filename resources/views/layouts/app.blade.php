...
<script src="{{url('assets/js/dashboard/dashboard-1.js')}}"></script>
    ...
    <script src="{{url('assets/js/plugins-init/sweetalert.init.js')}}"></script> --}}
    	<!-- Sweet Alert -->
	<script src="{{url('assets/plugin/sweetalert/sweetalert.min.js')}}"></script>


     <!-- Toastr -->
     <script src="{{url('assets/vendor/toastr/js/toastr.min.js')}}"></script>
<!-- jQuery UI -->
<script src="{{url('assets/plugin/jquery-ui-1.12.1.custom/jquery-ui.min.js')}}"></script>
<script src="{{url('assets/plugin/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js')}}"></script>
     <!-- All init script -->
